...
class LandmarkTrainDataset(Dataset):
    ...
    def __init__(self,
        ...
        if rhd_dataset is not None:
            for i in range(len(rhd_dataset)):
                self.items.append(("rhd", i, "right"))
                self.items.append(("rhd", i, "left"))
        self._freihand = freihand
        self._interhand = interhand
        self._rhd = rhd_dataset
        self.phase2_bbox = {}
